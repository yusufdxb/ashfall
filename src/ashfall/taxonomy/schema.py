...
TAXONOMY: dict[FailureMode, FailureModeSpec] = {
    ...
    FailureMode.SLIP: FailureModeSpec(
        ...
        label="Foot Slip",
        description="Near-zero motion under command; traction loss is one hypothesis.",
    ...
    FailureMode.STUMBLE: FailureModeSpec(
        ...
        label="Stumble",
        description="Joint velocity spike; foot catch requires independent confirmation.",

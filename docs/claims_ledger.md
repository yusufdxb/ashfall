...
| The same H0 spec and seeds give identical outcomes on the simulator | VERIFIED for three runs of the smoke spec | statuses, gate counts, incidences, exact p and verdict compared field by field |
